...
exports.bookinstance_delete_get = function(req, res) {
    async.parallel({
        ...
        // Successful, so render.c
        
        res.render('bookinstance_delete', { title: 'Delete Bookinstance', bookinstance: results.book } );
    });
    ...
    [
        ...
        (req, res, next) => {
            ...
            if (!errors.isEmpty()) {
                ...
                BookInstance.findByIdAndUpdate(req.params.id, bookinstance, {useFindAndModify : false}, function (err,thebookinstance) {
                    if (err) { return next(err); }
